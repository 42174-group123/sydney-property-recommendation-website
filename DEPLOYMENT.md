...
use bounded HPO, overwrite `data/runs/latest` on each retrain, and reuse the
same ClearML task names. ClearML still receives the model artifacts, metrics,
HPO tables, and plots needed for marking.
